...
<head>
	...
	<meta property="og:url" content="https://www.linepark.co.jp/news/newspage02.php">
	<!-- サイト全体のタイトル -->
	...
	<meta property="og:description" content="夏季休業のお知らせ">
	...
	<meta name="twitter:description" content="見学について">
	...
	<meta name="description" content="夏季休業のお知らせ">
	<meta name="keywords" content="就労継続支援B型, 就労継続支援事業所, 就B, B型, 足立区, 綾瀬, Web制作, HP制作, デザイン制作, 動画編集, バナー作成, チラシデザイン, 障害福祉, 夏季休業のお知らせ">
</head>
...
<body>
	...
	<div class="p-subhero p-subhero-newspage">
		<div class="p-subhero-heading">
			<span class="c-heading-subprimary-center c-heading-subprimary-center-white">News</span>
			<h2 class="c-heading-primary-center u-cts">
				お知らせ
			</h2>
		</div>
	</div>
	<div class="p-newspage-wrap">
		<div class="p-newspage-inner l-inner">
			<div class="p-newspage-heading">
				<time datetime="2023-07-27">2023-07-31</time>
				<div class="p-newspage-title">夏季休業のお知らせ</div>
				<span class="c-label-category">お知らせ</span>
			</div>
			<!-- <div class="p-newspage-container"> -->
			<div class="p-newspage-body">
				<p>平素より格別のお引き立てをいただき厚くお礼申し上げます。<br>
					弊社では、誠に勝手ながら下記日程を夏季休業とさせていただきます。</p>
				<br>
				<strong>
					<p>■夏季休業期間</p>
					<p>2023年08月11日(金)　～　08月15日(火)</p>
				</strong>
				<br>
				<p>休業期間中にいただいたお問合せについては、営業開始日以降に順次回答させていただきます。</p>
				<p>皆様には大変ご不便をおかけいたしますが、何卒ご理解の程お願い申し上げます。
			</div>
			<!-- <div class="p-newspage-body">
				<img src="/img/summer-break.jpg" alt="">
			</div> -->
			<!-- </div> -->
			<div class="p-newspage-link">
				<a href="/" class="c-btn-round u-cts">ホームに戻る</a>
			</div>
		</div>
	</div>
