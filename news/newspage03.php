...
<head>
	...
	<meta property="og:url" content="https://www.linepark.co.jp/news/newspage03.php">
	<!-- サイト全体のタイトル -->
	<meta property="og:site_name" content="株式会社ＬｉＮＥ ＰＡＲＫ">
	<!-- ページ固有のタイトル -->
	<meta property="og:title" content="体験について">
	<!-- 1200x630pxの画像を指定 -->
	...
	<meta property="og:description" content="体験についてのお知らせ">
	...
	<meta name="twitter:description" content="体験について">
	...
	<title>体験について</title>
	<meta name="description" content="体験について">
	<meta name="keywords" content="就労継続支援B型,就労継続支援事業所, B型, 足立区, 綾瀬, Web制作, デザイン制作, 動画編集, バナー作成, チラシデザイン, 障害福祉, ホームページ制作, 体験について">
</head>
	...
	<div class="p-newspage-wrap">
		<div class="p-newspage-inner l-inner">
			<div class="p-newspage-heading">
				...
				<div class="p-newspage-title">体験について</div>
				<span class="c-label-category">お知らせ</span>
			</div>
			<div class="p-newspage-body">
				<p>見学後に日程の設定を行います。<br>
					（体験期間は1日〜1週間ぐらいですが、場合により、それ以上行った例も御座います。）</p>
			</div>
