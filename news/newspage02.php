...
<head>
	...
	<!-- ページ固有のタイトル -->
	<meta property="og:title" content="見学について">
	<!-- 1200x630pxの画像を指定 -->
	...
	<meta property="og:description" content="見学について">
	...
	<title>見学について</title>
	<meta name="description" content="見学について">
	<meta name="keywords" content="就労継続支援B型, 就労継続支援事業所, 就B, B型, 足立区, 綾瀬, Web制作, HP制作, デザイン制作, 動画編集, バナー作成, チラシデザイン, 障害福祉, 見学について">
</head>
	...
	<div class="p-newspage-wrap">
		<div class="p-newspage-inner l-inner">
			<div class="p-newspage-heading">
				...
				<div class="p-newspage-title">見学について</div>
				<span class="c-label-category">お知らせ</span>
			</div>
			<div class="p-newspage-body">
				<p>お近くのハローワーク、他事業所のご紹介、または直接のご連絡にてお申込みください。<br>
					ご見学では、色々なお話をお伺いするかと思いますが、お話したくないこと等は御察しいたしますので、ご安心ください。</p>
			</div>
